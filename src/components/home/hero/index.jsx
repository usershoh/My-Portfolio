    ...
    <section className="grid sm:flex justify-between  gap-[20px]">
      ...
      <div className="p-[30px] md:pt-[100px]">
        <h1 className="text-[24px] lg:text-[48px] font-[600] text-dark">
          Hello I'm Shokhjakhon I'm Frontend developer
        </h1>
        <div className="hidden sm:flex items-center gap-[10px] text-[20px] pt-[20px]">
          <button onClick={() => navigate("/project")} className="text-gold hover:text-hover">
            See project
          </button>
          <button onClick={() => navigate("/about")} className="text-gold hover:text-hover">
            About me
          </button>
        </div>
      </div>
