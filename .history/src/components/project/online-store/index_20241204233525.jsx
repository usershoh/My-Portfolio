  ...
  return (
    <div className="border-[2px] border-[#FFC107] bg-[#FFF7E0] p-6 shadow-lg max-w-[800px] mx-auto rounded-lg grid gap-[10px]">
      ...
      <div className="mt-[10px] text-center">
        <a className="inline-block font-semibold  rounded-lg shadow hover:bg-[#FFB300] px-6 py-3 bg-[#FFC107] text-[#333]" href="https://github.com/usershoh/Login">GitHub Link</a>
      </div>
    </div>
  );
};
