...
import onlineStoreImg1 from "../../../assets/img/onlineStore-img2.png";
import onlineStoreImg1 from "../../../assets/img/onlineStore-img3.png";
import onlineStoreImg1 from "../../../assets/img/onlineStore-img4.png";
import onlineStoreImg1 from "../../../assets/img/onlineStore-img5.png";
import onlineStoreImg1 from "../../../assets/img/onlineStore-img1.png";

const OnlineStoreProject = () => {
  return (
    <div className="border-[2px] border-[#c49b1d] p-[10px] rounded-lg grid gap-[10px]">
      <h1>Onsline Store Market</h1>
