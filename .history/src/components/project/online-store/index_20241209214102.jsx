  ...
  return (
    <div className="border-[2px] border-[#FFC107] bg-[#FFF7E0] p-6 shadow-lg max-w-[800px] mx-auto rounded-lg grid gap-[10px]">
      ...
      <div className="grid gap-4">
        ...
        <p className="text-[16px] text-dark">
          <strong>Discription:</strong> Online store with registration option, there are 4 pages with individual products in JS <span className="text-gold">project completed</span>
        </p>
        <p className="text-[16px] text-dark">
