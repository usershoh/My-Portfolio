  ...
  return (
    <div className="border-[2px] p-6 border-[#FFC107] bg-[#FFF7E0] shadow-lg max-w-[800px] mx-auto rounded-lg grid gap-[10px]">
      ...
      <div className="grid gap-4">
        ...
        <p className="text-[16px] text-dark">
          <strong>Discription: </strong> Portfolio site with more detailed information about me and my projects
        </p>
        <p className="text-[16px] text-dark">
          <strong>Technologies: </strong> HTML, CSS, JS, REACT: TAILWIND, REACT-ROUTER-DOM, JSON-SERVER
        </p>
        <p className="text-[16px] text-dark">
