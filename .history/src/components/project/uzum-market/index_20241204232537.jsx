...
const UzumMarketProject = () => {
  return (
    <div className="border-[2px] p-6 border-[#FFC107] bg-[#FFF7E0] shadow-lg max-w-[900px] mx-auto rounded-lg grid gap-[10px]">
      <h1 className="text-[24px] text-dark font-semibold">Uzum market copy</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 items-center gap-[10px] mt-6 lg:w-[700px]">
        <div className=" border border-dark border border-[#FFC107] rounded-lg">
