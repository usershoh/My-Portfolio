...
import uzumImg2 from "../../../assets/img/uzum-img1.png";
import uzumImg3 from "../../../assets/img/uzum-img1.png";
...
const UzumMarketProject = () => {
  return (
    <div className="border-[2px] border-[#c49b1d] p-[10px] rounded-lg">
      ...
      <p className="text-[14px] text-dark">
        <strong>Working with:</strong> local storeage, complex shop page logic,
        separate pages for each product, working with json-server, like and cart
        functionality and like page Dynamic interface update.
      </p>
      <div></div>
    </div>
  );
