...
const About = () => {
  ...
  return (
    <div>
      <div className="w-[50%] m-auto text-c">
        ...
        <p className="text-[16px] text-dard">
          ...
          HTML, CSS, JavaScript, and React. I am constantly learning and
          expanding my skills, currently diving deeper into TypeScript, SASS,
          and exploring various React libraries
        </p>
      </div>

      <div className="grid grid-cols-2 mt-[20px] w-[420px] gap-[10px]">
